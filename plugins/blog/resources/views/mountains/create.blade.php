                        ...
                        <div class="tab-pane active" id="tab_detail">
                            <div class="form-body">
                                <div class="form-group @if ($errors->has('name')) has-error @endif">
                                    <label for="name" class="control-label required">{{ trans('blog::mountains.form.name') }}</label>
                                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'id' => 'name', 'placeholder' => trans('blog::mountains.form.name_placeholder'), 'data-counter' => 120]) !!}
                                ...
                                <div class="form-group @if ($errors->has('date_of_the_incident')) has-error @endif">
                                    ...
                                    {!! Form::date('date_of_the_incident', old('date_of_the_incident'), ['class' => 'form-control', 'id' => 'date_of_the_incident', 'placeholder' => trans('blog::mountains.form.name_placeholder')]) !!}
                                    {!! Form::error('date_of_the_incident', $errors) !!}
                                </div>
                                <div class="form-group @if ($errors->has('notes')) has-error @endif">
                                    <label class="control-label required">{{ trans('blog::mountains.form.note') }}</label>
                                    {!! render_editor('notes', old('notes'), true) !!}
