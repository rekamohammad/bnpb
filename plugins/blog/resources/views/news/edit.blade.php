                        ...
                        <div class="tab-pane active" id="tab_detail">
                            <div class="form-body">
                                <div class="form-group @if ($errors->has('name')) has-error @endif">
                                    ...
                                    {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'name', 'placeholder' => trans('blog::news.form.name_placeholder'), 'data-counter' => 120]) !!}
                                    {!! Form::error('name', $errors) !!}
                                </div>
                                <div class="form-group @if ($errors->has('slug')) has-error @endif">
                                    {!! Form::permalink('slug', $post->slug, $post->id, route('news.create.slug'), route('public.single.detail', config('cms.slug.pattern')), url('/')) !!}
                                ...
                                <div class="form-group @if ($errors->has('featured')) has-error @endif">
                                    ...
                                    <label for="featured">{{ trans('blog::news.form.slide') }}</label>
