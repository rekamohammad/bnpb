...
class DioramaCacheDecorator extends CacheAbstractDecorator implements AlbumInterface
{
     ...
     * @author Sang Nguyen
     */
    public function __construct(AlbumInterface $repository, CacheInterface $cache)
    {
