...
class MountainsCacheDecorator extends CacheAbstractDecorator implements MountainsInterface
{
     ...
     * @author Sang Nguyen
     */
    public function __construct(MountainsInterface $repository, MountainsInterface $cache)
    {
