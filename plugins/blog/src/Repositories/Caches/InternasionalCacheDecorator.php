...
class InternasionalCacheDecorator extends CacheAbstractDecorator implements InternasionalInterface
{
     ...
     * @author Sang Nguyen
     */
    public function __construct(InternasionalInterface $repository, CacheInterface $cache)
    {
