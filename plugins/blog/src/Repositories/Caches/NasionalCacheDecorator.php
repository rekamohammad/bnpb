...
class NasionalCacheDecorator extends CacheAbstractDecorator implements NasionalInterface
{
     ...
     * @author Sang Nguyen
     */
    public function __construct(NasionalInterface $repository, CacheInterface $cache)
    {
