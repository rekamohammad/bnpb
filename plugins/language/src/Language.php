...
class Language
{
    ...
    {
        $screen = [PAGE_MODULE_SCREEN_NAME, MENU_MODULE_SCREEN_NAME];
        ...
        return apply_filters(LANGUAGE_FILTER_MODEL_USING_MULTI_LANGUAGE, $screen);
    }
    ...
    {
        $meta = app(LanguageMetaInterface::class)->getModel()->where('lang_meta_origin', '=', $unique_key);
